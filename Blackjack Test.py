...
if Dealer4 > 21:
   ...
   print("Du hast eine Perfekte Hand. Du Hast Gewonnen!")
   exit()
elif Dealer4 == 21:
   print("Dealer hat eine Perfekte Hand. Dealer Gewinnt")
   exit()
elif Dealer4 <= 16:
...
if Dealer == 21:
        print("Dealer hat perfekt 21 unr Hat damit Gewonnen!")
elif Spieler == 21:
        print("Du hast Perfekt 21. Du hast Gewonnen!")
